...
export default function Orders() {
  ...
  const { orders, restaurants, clients, editingOrder, orderStatuses } = useLoaderData<typeof loader>();
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {orders.map((order: DetailedOrder) => (
          ...
          attributes={[
            ...
            { key: "Client", label: `${order.client.name} ${order.client.surname}` },
            { key: "Status", label: ORDER_STATUSES[order.status] }, 
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded-lg w-96">
            ...
            <Form method="post" className="space-y-4">
              ...
              <div>
                <label className="block mb-2">Edit Status</label>
                <select
                  name="status"
